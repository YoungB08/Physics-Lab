...
export const api = {
  ...
  createChatConversation: (payload: { lessonSlug: string; tieuDe?: string; firstMessage?: string }) => request<any>('/chat/conversations', { method: 'POST', body: JSON.stringify(payload) }),
